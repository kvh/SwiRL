...
Item::
Item(const Item& itm) :
  start_(itm.start()), finish_(itm.finish()), term_(itm.term()), 
  word_(itm.word()) {}
...
: //head_ (hd),
  start_( _start ), finish_( _finish ), term_( _term ), 
  word_( NULL ), needme_(), ineed_(),
  prob_( 1.0 ), poutside_( 0.0 ), storeP_( 0.0 )
{}
